...
#Code analysis - The code for walking works as intendid with the player going as the set speed when pressing the walk forward key and it doest need to be inporved due to it having any issues with it not working.
...
const MOUSE_SENSITIVITY_SCROLL_WHEEL = 10
